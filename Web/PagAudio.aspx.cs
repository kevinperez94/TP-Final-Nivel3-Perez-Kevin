...
namespace Web
{
    public partial class PagAudio : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    Session.Add("listaAudio", negocio.listaAudioSP());
                    repRepetidor.DataSource = Session["listaAudio"];
                    repRepetidor.DataBind();

                    CategoriaNegocio categoria = new CategoriaNegocio();
                    List<Categoria> listaC = categoria.listarAudio();
        ...
        protected void txtBuscar_TextChanged(object sender, EventArgs e)
        {
            try
            {
                List<Articulo> busqueda = (List<Articulo>)Session["listaAudio"];
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                List<Articulo> listaApple = (List<Articulo>)Session["listaAudio"];
