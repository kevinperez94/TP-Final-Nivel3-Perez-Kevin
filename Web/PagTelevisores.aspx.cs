...
namespace Web
{
    public partial class PagTelevisores : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    Session.Add("listaTelevisores", negocio.listaTelevisoreSP());
                    repRepetidor.DataSource = Session["listaTelevisores"];
                    repRepetidor.DataBind();

                    CategoriaNegocio categoria = new CategoriaNegocio();
                    List<Categoria> listaC = categoria.listarTV();
        ...
        protected void txtBuscar_TextChanged(object sender, EventArgs e)
        {
            try
            {
                List<Articulo> busqueda = (List<Articulo>)Session["listaTelevisores"];
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                List<Articulo> listaApple = (List<Articulo>)Session["listaTelevisores"];
