<%@ Page Title="Nuestro catálogo media!" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PagMedia.aspx.cs" Inherits="Web.PagMedia" %>
    ...
    <div class="row">
        <div class="col">
            <div class="mb-3 centrar">
                <asp:Image ImageUrl="~/Images/media.png" CssClass="imagen-centrar" runat="server" />
            </div>
        </div>
    </div>
    <hr />
