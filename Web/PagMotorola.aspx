<%@ Page Title="Nuestro catálogo Motorola!" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PagMotorola.aspx.cs" Inherits="Web.PagMotorola" %>
    ...
    <div class="row">
        <div class="col">
            <div class="mb-3 centrar-texto">
                <h1>Encuentra los productos Motorola</h1>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col">
            <div class="mb-3 centrar">
                <asp:Image ImageUrl="~/Images/motorola-banner.jpg" CssClass="imagen-centrar" runat="server" />
            </div>
        </div>
    </div>
    <hr />
    <asp:UpdatePanel runat="server" ID="upFiltrar">
        <ContentTemplate>
            <div class="row">
                <div class="col-3">
                    <div class="mb-3">
                ...
                <div class="col-3">
                    <div class="mb-3">
                        ...
                        <asp:DropDownList CssClass="form-select" ID="ddlCategoria" OnSelectedIndexChanged="ddlCategoria_SelectedIndexChanged" AutoPostBack="true" runat="server"></asp:DropDownList>
                    </div>
                </div>
                <div class="col-3">
                    <div class="mb-3">
                        <br />
                        <asp:TextBox runat="server" CssClass="form-control" ID="txtBuscar" OnTextChanged="txtBuscar_TextChanged" placeholder="Modelo" TextMode="Search" />
                    </div>
                </div>
                <div class="col-3">
                    <div class="mb-3">
