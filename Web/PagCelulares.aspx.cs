...
namespace Web
{
    public partial class PagCelulares : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    Session.Add("listaCelulares", negocio.listaCelularesSP());
                    repRepetidor.DataSource = Session["listaCelulares"];
                    repRepetidor.DataBind();

                    CategoriaNegocio categoria = new CategoriaNegocio();
                    List<Categoria> listaC = categoria.listarCelular();
        ...
        protected void txtBuscar_TextChanged(object sender, EventArgs e)
        {
            try
            {
                List<Articulo> busqueda = (List<Articulo>)Session["listaCelulares"];
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                List<Articulo> listaApple = (List<Articulo>)Session["listaCelulares"];
