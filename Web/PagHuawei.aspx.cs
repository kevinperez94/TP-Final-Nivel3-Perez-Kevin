...
namespace Web
{
    public partial class PagHuawei : System.Web.UI.Page
    {
        public List<Articulo> listaHuawei { get; set; }
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    Session.Add("listaHuawei", negocio.listaHuaweiSP());
                    repRepetidor.DataSource = Session["listaHuawei"];
                    repRepetidor.DataBind();

                    MarcaNegocio marca = new MarcaNegocio();
                    List<Marca> listaM = marca.listarHuawei();
        ...
        protected void txtBuscar_TextChanged(object sender, EventArgs e)
        {
            try
            {
                List<Articulo> busqueda = (List<Articulo>)Session["listaHuawei"];
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                List<Articulo> listaHuawei = (List<Articulo>)Session["listaHuawei"];
                List<Articulo> articulosFiltrados = listaHuawei;
