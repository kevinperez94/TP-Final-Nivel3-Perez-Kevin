<%@ Page Title="Nuestro catálogo Samsung!" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PagSamsung.aspx.cs" Inherits="Web.PagSamsung" %>
    ...
    <div class="row">
        ...
        <div class="col">
            <div class="mb-3 centrar-texto">
                <h1>Encuentra los productos Samsung</h1>
            </div>
        </div>
        <div class="col-2"></div>
    </div>
    <div class="row">
        <div class="col">
            <div class="mb-3 centrar">
                <asp:Image ImageUrl="~/Images/Samsung-banner.png" CssClass="imagen-centrar" runat="server" />
            </div>
        </div>
    </div>
    <hr />
        ...
        <ContentTemplate>
            <div class="row">
                ...
                <div class="col-3">
                    <div class="mb-3">
                        <br />
                        <asp:TextBox runat="server" CssClass="form-control" ID="txtBuscar" OnTextChanged="txtBuscar_TextChanged" TextMode="Search" placeholder="Modelo" />
                    </div>
                </div>
                <div class="col-3">
                    <div class="mb-3">
                        <br />
                        <asp:Button Text="Buscar" CssClass="btn btn-primary" OnClick="btnBuscar_Click" ID="btnBuscar" runat="server" />
                    </div>
                </div>
            </div>
            <hr />
