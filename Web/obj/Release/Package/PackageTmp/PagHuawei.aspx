<%@ Page Title="Nuestro catálogo Huawei!" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PagHuawei.aspx.cs" Inherits="Web.PagHuawei" %>
    ...
    <div class="row">
        <div class="col">
            <div class="mb-3 centrar-texto">
                <h1>Encuentra los productos Huawei</h1>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col">
            <div class="mb-3 centrar">
                <asp:Image ImageUrl="~/Images/huawei-banner.jpg" CssClass="imagen-centrar" runat="server" />
            </div>
        </div>
    </div>
    <hr />
