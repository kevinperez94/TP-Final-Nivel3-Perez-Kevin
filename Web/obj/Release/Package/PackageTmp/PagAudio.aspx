<%@ Page Title="Nuestro catálogo en audio!" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PagAudio.aspx.cs" Inherits="Web.PagAudio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="mb-3 centrar-texto">
            <h1>Encuentra el producto que quieres</h1>
        </div>
    </div>
    <div class="row">
        <div class="col">
            <div class="mb-3 centrar">
                <asp:Image ImageUrl="~/Images/audio.png" CssClass="imagen-centrar" runat="server" />
            </div>
        </div>
    </div>
    <hr />
