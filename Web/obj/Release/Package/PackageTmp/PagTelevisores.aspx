<%@ Page Title="Nuestro catálogo en televisores!" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PagTelevisores.aspx.cs" Inherits="Web.PagTelevisores" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="mb-3 centrar-texto">
            <h1>Encuentra el televisor que quieres</h1>
        </div>
    </div>
    <div class="row">
        <div class="col">
            <div class="mb-3 centrar">
                <asp:Image ImageUrl="~/Images/televisores.png" CssClass="imagen-centrar" runat="server" />
            </div>
        </div>
    </div>
    <hr />
            ...
            <div class="row">
                <div class="col-3">
                    <div class="mb-3">
                        ...
                        <asp:DropDownList runat="server" CssClass="form-select" ID="ddlCategoria" AutoPostBack="true"></asp:DropDownList>
                    </div>
                </div>
                <div class="col-3">
                    <div class="mb-3">
