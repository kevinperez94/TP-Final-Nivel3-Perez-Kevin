<%@ Page Title="Nuestro catálogo en celulares" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PagCelulares.aspx.cs" Inherits="Web.PagCelulares" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="mb-3 centrar-texto">
            <h1>Encuentra el celular que quieres</h1>
        </div>
    </div>
    <div class="row">
        <div class="col">
            <div class="mb-3 centrar">
                <asp:Image ImageUrl="~/Images/celulares.png" CssClass="imagen-centrar" runat="server" />
            </div>
        </div>
    </div>
    <hr />
