...
namespace Web
{
    public partial class PagMotorola : System.Web.UI.Page
    {
        public List<Articulo> listaMotorola { get; set; }
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    Session.Add("listaMotorola", negocio.listaMotorolaSP());
                    repRepetidor.DataSource = Session["listaMotorola"];
                    repRepetidor.DataBind();

                    MarcaNegocio marca = new MarcaNegocio();
                    List<Marca> listaM = marca.listarMotorola();
        ...
        protected void txtBuscar_TextChanged(object sender, EventArgs e)
        {
            try
            {
                List<Articulo> busqueda = (List<Articulo>)Session["listaMotorola"];
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                List<Articulo> listaMotorola = (List<Articulo>)Session["listaMotorola"];
                List<Articulo> articulosFiltrados = listaMotorola;
