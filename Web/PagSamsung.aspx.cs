...
namespace Web
{
    public partial class PagSamsung : System.Web.UI.Page
    {
        public List<Articulo> listaSamsung { get; set; }
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    Session.Add("listaSamsung", negocio.listaSamsungSP());
                    repRepetidor.DataSource = Session["listaSamsung"];
                    repRepetidor.DataBind();

                    MarcaNegocio marca = new MarcaNegocio();
                    List<Marca> listaM = marca.listarSamsung();
        ...
        protected void txtBuscar_TextChanged(object sender, EventArgs e)
        {
            try
            {
                List<Articulo> busqueda = (List<Articulo>)Session["listaSamsung"];
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                List<Articulo> listaSamsung = (List<Articulo>)Session["listaSamsung"];
                List<Articulo> articulosFiltrados = listaSamsung;
