...
namespace Web
{
    public partial class PagApple : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    Session.Add("listaApple", negocio.listaAppleSP());
                    repRepetidor.DataSource = Session["listaApple"];
                    repRepetidor.DataBind();

                    MarcaNegocio marca = new MarcaNegocio();
                    List<Marca> listaM = marca.listarApple();
        ...
        protected void txtBuscar_TextChanged(object sender, EventArgs e)
        {
            try
            {
                List<Articulo> busqueda = (List<Articulo>)Session["listaApple"];
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                List<Articulo> listaApple = (List<Articulo>)Session["listaApple"];
