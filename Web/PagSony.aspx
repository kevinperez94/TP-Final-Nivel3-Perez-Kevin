<%@ Page Title="Nuestro catálogo Sony!" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PagSony.aspx.cs" Inherits="Web.PagSony" %>
    ...
    <div class="row">
        <div class="col">
            <div class="mb-3 centrar-texto">
                <h1>Encuentra los productos Sony</h1>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col">
            <div class="mb-3 centrar">
                <asp:Image ImageUrl="~/Images/Sony-banner.jpg" CssClass="imagen-centrar" runat="server" />
            </div>
        </div>
    </div>
    <hr />
